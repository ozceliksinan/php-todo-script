                  ...
                  <form onsubmit="return false" id="kayitformu">
                    ...
                    <div class="form-row d-flex justify-content-around">
                      <div class="col-md-6 form-group">
                        ...
                        <input type="password" name="kul_sifre" placeholder="Şifrenizi Girin"
                          class="form-control not-sifresi">
                      </div>
                      <div class="col-md-6 form-group">
                        <label>Şifreniz Tekrar Girin</label>
                        <input type="password" placeholder="Şifreniz Tekrar Girin"
                          class="form-control not-sifresi-tekrar">
                      </div>
                    </div>
