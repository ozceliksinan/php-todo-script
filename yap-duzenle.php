					...
					<form action="islemler/ajax.php" method="POST" accept-charset="utf-8">
						<div class="form-row d-flex justify-content-center text-center">
							<div class="col-md-6 form-group">
								<label>Başlık</label>
								<input required="" type="text" name="yap_baslik" placeholder="Yapılacak İşlem Başlığı"
						...
						<div class="form-row d-flex justify-content-center text-center">
							<div class="col-md-6 form-group">
								<div class="custom-control custom-checkbox mr-sm-2">
									<input <?php if ($yapilacak['yap_mail_onay'] == 1) {
										echo "checked";
									} ?> type="checkbox"
										class="custom-control-input" id="mailgondermeonay" name="yap_mail_onay"
										value="1">
						...
						<div class="form-row d-flex justify-content-center text-center">
							<div class="col-md-11 form-group">
								...
								<textarea id="editor" required="" name="yap_detay" class="form-control"
									style="height: 20rem"
