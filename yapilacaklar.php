          ...
          <tbody>
            ...
            while ($yapilacaklar = $sorgu->fetch(PDO::FETCH_ASSOC)) {
              ...
              <tr>
                ...
                if (yetkikontrol()) { ?>
                  <td>
                    <?php echo $yapilacaklar['kul_isim']; ?>
                  </td>
                <?php } ?>
                <td>
                  <?php echo $yapilacaklar['yap_baslik']; ?>
                </td>
                <td>
                  <?php echo $yapilacaklar['yap_islem_tarih']; ?>
                </td>
                <td>
                  <?php echo mb_substr($yapilacaklar['yap_detay'], 0, 50); ?>
                </td>
                <td>
                  <?php echo $yapilacaklar['yap_eklenme_tarih']; ?>
                </td>
                <td>
                  <?php
